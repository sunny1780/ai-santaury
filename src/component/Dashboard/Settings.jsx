          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 bg-white rounded-xl border border-[#E5E7EB] overflow-hidden">
            ...
            <div className="p-7 flex flex-col items-center justify-center">
              <div className="inline-flex items-center rounded-full border border-[#E5E7EB] p-1 mb-3">
                <span className="text-[11px] px-3 py-1 rounded-full bg-[#EFF6FF] text-[#2563EB]">Monthly</span>
                <span className="text-[11px] px-3 py-1 text-[#6B7280]">Yearly (20%)</span>
              </div>
              ...
              <button
                type="button"
                className="mt-5 rounded-full bg-[#2563EB] text-white px-8 py-2.5 text-base font-medium"
                style={{ fontFamily: 'Manrope, sans-serif' }}
              >
